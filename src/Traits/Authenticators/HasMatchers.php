...
trait HasMatchers
{
    ...
    protected function findAuthenticatable(Authenticatable $authenticatable, array $credentials): ?Authenticatable
    {
    ...
    protected function findMatcherAuthenticatable(MatcherInterface $matcher, Authenticatable $authenticatable, array $credentials): ?Authenticatable
    {
